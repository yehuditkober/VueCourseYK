# Class Task
* use the following link https://restcountries.eu/rest/v2/all?fields=name to get json data
Request result (250 country names):
```json
...
* Get a random number (between 0-249), and select the name of the country that is stored in the array at this index

* Create a new request to the server, to get all the data of the country that we selected in the prev step. use this link https://restcountries.eu/rest/v2/name/israel
Request result (full country info):
```json
[
    {
        "name": "Israel",
...
* Display the response data to the user (the UI  - is your choice)
